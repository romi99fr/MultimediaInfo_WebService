...
public class MultimediaInfoEndpoint {
    ...
    public ResponseEntity<String> getAllFilesContent() {
        ...
        for(File file : files) {
            ...
            content.append("Titles: ").append(fileTitles).append("\n");
            content.append("Descriptions: ").append(fileDescriptions).append("\n");
            content.append("Keywords: ").append(fileKeywords).append("\n");
        }
    ...
    public ResponseEntity<String> getFileTitles(@PathVariable("hash") String hash) {
        ...
        content.append(fileTitles).append("\n");
        return new ResponseEntity<>(content.toString(), HttpStatus.OK);
    }
    ...
    public ResponseEntity<String> getFileDescriptions(@PathVariable("hash") String hash) {
        ...
        content.append(fileDescriptions).append("\n");
        return new ResponseEntity<>(content.toString(), HttpStatus.OK);
    }
    ...
    public ResponseEntity<String> getFileKeywords(@PathVariable("hash") String hash) {
        ...
        content.append(fileKeywords).append("\n");
        return new ResponseEntity<>(content.toString(), HttpStatus.OK);
    }
    ...
    public ResponseEntity<String> searchByAnytype(@RequestBody String anytype) {
        ...
        content.append("Found files with string ").append(anytype).append(" as title: ").append(foundTitles).append("\n");
        content.append("Found files with string ").append(anytype).append(" as description: ").append(foundDescriptions).append("\n");
        content.append("Found files with string ").append(anytype).append(" as keyword: ").append(foundKeywords).append("\n");
        return new ResponseEntity<>(content.toString(), HttpStatus.OK);
    }
    ...
    public ResponseEntity<String> searchByTitle(@RequestBody String title) {
        ...
        content.append("Found files with string ").append(title).append(" as title: ").append(foundTitles).append("\n");
        return new ResponseEntity<>(content.toString(), HttpStatus.OK);
    }
    ...
    public ResponseEntity<String> searchByDescription(@RequestBody String description) {
        ...
        content.append("Found files with string ").append(description).append(" as description: ").append(foundDescriptions).append("\n");
        return new ResponseEntity<>(content.toString(), HttpStatus.OK);
    }
    ...
    public ResponseEntity<String> searchByKeyword(@RequestBody String keyword) {
        ...
        content.append("Found files with string ").append(keyword).append(" as description: ").append(foundKeywords).append("\n");
        return new ResponseEntity<>(content.toString(), HttpStatus.OK);
    }
}